...
class CoinPriceService: NSObject {
    ...
    func connect() {
        ...
        let url = URL(string: "wss://ws.coincap.io/prices?assets=bitcoin,ethereum,monero,litecoin")!
...
extension CoinPriceService: URLSessionWebSocketDelegate {
